...
```bash
curl -fsSLO https://github.com/Fovty/hushmic/releases/latest/download/hushmic_0.5.1-1_amd64.deb
sudo apt install ./hushmic_0.5.1-1_amd64.deb
```
...
> `sudo apt install ./hushmic_0.5.1-1_amd64.deb wireplumber pipewire-media-session-`
